...
WHERE Jobs.job_category_id = '$jobCatId' 
OR Jobs.job_type_id = '$jobTypeId'
...
OR Personalities.id = '$PersonalitiesId' 
OR PracticalSkills.id = '$PracticalSkillsId' 
OR BasicAbilities.id = '$BasicAbilitiesId' 
OR Tools.id = '$ToolsId' 
...
/** mostly like statement will take time to process, since i dont know the database schema flow i only state few query for like statement 
- changes :
    - Jobs.job_category_name to Jobs.job_category_id
    - Jobs.job_type_name to Jobs.job_type_id
    - Personalities.name to Personalities.id
    - PracticalSkills.name to PracticalSkills.id
    - BasicAbilities.name to BasicAbilities.id
    - Tools.name to Tools.id
    - publish_status to Jobs.publish_status
**/
